...
export const AffectationsGestion: FunctionComponent<AffectationsGestionProps> = () => {
    ...
    const handleSaveNew = async () => {
        ...
        if (success) {
            ...
            await loadData();
            showToast.success('Affectation ajoutee avec succes');
        } else {
            ...
            <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                <div className="flex flex-wrap items-center justify-between gap-2 border-b border-gray-100 px-4 py-3">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        {canWrite('AFFECTATIONS') && <ActionButton onClick={openAddModal} icon={Plus}>Ajouter</ActionButton>}
                                ...
                                {paged.map((row) => {
                                    ...
                                    return (
                                        <tr key={row.ID}>
                                            ...
                                            <td className="px-2 py-2">
                                                <SelectSearch
                                                    options={rowArticles.map((a) => ({ id: a.id, label: a.code }))}
